    ...
    <Flex flexDir="column" alignItems="center" zIndex="1">
      <CenterContainer>
        ...
        <PageHeader
          ...
          description={  <SplitText>'Casper Network community project that unites DAO platform for creators and investors with a project incubation HUB Decentralized Autonomous Launchpad and Venture Capital'</SplitText>
          }
