...
export const StoreIntro = () => {
  return (
    <CenterContainer>
      ...
      />
      <Flex justify={{base: "initial", xl: "center"}} gap="20px" mb="60px" maxW="100vw" overflowX="scroll" padding="0px 20px" pb="40px">
        <RoundItem 
			index={1}
			price={50}
			percent={75}
      ...
      <Grid templateColumns={{base: "1fr", lg: "1fr 1fr"}} gridGap={{base: "40px", md: "120px"}} mb="100px" padding={{base: "20px", lg: "0px"}}>
        <Flex flexDir="column" gap="35px">
          <Box letterSpacing="0.8em" fontFamily="CHANEY" fontSize="12px" color="#888888">SALES PROCESS</Box>
